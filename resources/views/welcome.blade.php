...
<head>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      .container-custom {
        padding: 60px 20px; /* Tambahan padding atas & bawah */
      }
  ...
  <div class="container container-custom">
    <div class="row align-items-center">
      <div class="col-lg-6 text-center text-lg-start">
        ...
        <p>Mudah mengelola data perpustakaan : mengatur kategori, penerbit, dan koleksi buku dengan lebih terorganisir.</p>
      ...
      <div class="col-lg-6 text-center mt-4 mt-lg-0 image">
